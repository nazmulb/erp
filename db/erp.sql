...
insert  into `tbl_user`(`uid`,`uname`,`first_name`,`last_name`,`password`,`email`,`phone`,`image`,`status`) values (1,'admin','Nazmul','Basher','92668751','nazmul.basher@gmail.com','+8801712994064',NULL,1),(2,'alamin','Al','Amin','-1415201540','enalamin@gmail.com','+8801677073455',NULL,1);
